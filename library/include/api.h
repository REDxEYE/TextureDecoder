...
DLL_EXPORT uint32_t get_texture_width(sTexture *texture);
DLL_EXPORT uint32_t get_texture_height(sTexture *texture);
DLL_EXPORT ePixelFormat get_texture_pixel_format(sTexture *texture);
